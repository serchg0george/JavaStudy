...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Student studentWithoutParameters = new Student();
        Student studentAllParameters = new Student(1, "Student", "With parameters", 4, 5.5,5.5,5.5);
        Student studentWithPartialParameters = new Student(2, "Student", "With partial parameters", 3);
