...
public class StudentTest {
    ...
    Student secondStudent = new Student("Ilya", 4, 9.5);

    public void simpleCompareTwoStudents() {
        if (firstStudent.name.equals(secondStudent.name) && firstStudent.course == secondStudent.course && firstStudent.grade == secondStudent.grade) {
